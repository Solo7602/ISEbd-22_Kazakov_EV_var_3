...
namespace AbstractFactoryBusinessLogic.MailWorker
{
	public class MailKitWorker : AbstractMailWorker
	{
		...
		public MailKitWorker(IMessageInfoLogic messageInfoLogic, IClientStorage clientStorage, IMessageInfoStorage messageInfoStorage) : base(messageInfoLogic, clientStorage, messageInfoStorage)
		{
