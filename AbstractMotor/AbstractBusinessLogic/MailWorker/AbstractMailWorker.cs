...
namespace AbstractFactoryBusinessLogic.MailWorker
{
    public abstract class AbstractMailWorker
    {
        static protected string _mailLogin;
        static protected string _mailPassword;
        static protected string _smtpClientHost;
        static protected int _smtpClientPort;
        static protected string _popHost;
        static protected int _popPort;
