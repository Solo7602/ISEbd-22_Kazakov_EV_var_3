using AbstractClientAPI.Models;
...
namespace AbstractClientAPI.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            EngineViewModel prod =
            APIClient.GetRequest<EngineViewModel>($"api/main/getproduct?productId={engine}");
