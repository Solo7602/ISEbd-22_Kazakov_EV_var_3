...
{
    public partial class FormComponentToEngine : Form
    {
        private readonly IReportLogic _logic;
        public FormComponentToEngine(IReportLogic logic)
        {
            InitializeComponent();
            _logic = logic;
        }

        private void FormComponentToEngine_Load(object sender, EventArgs e)
        {
            try
            {
