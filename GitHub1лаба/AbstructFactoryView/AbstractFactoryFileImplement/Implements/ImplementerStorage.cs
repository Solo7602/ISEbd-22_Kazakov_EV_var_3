...
namespace AbstractFactoryFileImplement.Implements
{
    public class ImplementerStorage
    {
        ...
        public ImplementerViewModel GetElement(ImplementerBindingModel model)
        {
            ...
            Implementers implementer = _source.Implementers.FirstOrDefault(rec => rec.ImplementerFIO.Equals(model.ImplementerFIO) || rec.Id.Equals(model.Id));
        ...
        public void Insert(ImplementerBindingModel model)
        {
            ...
            var implementer = new Implementers { Id = maxId + 1 };
            _source.Implementers.Add(CreateModel(model, implementer));
        }

        public void Update(ImplementerBindingModel model)
        {
            Implementers implementer = _source.Implementers.FirstOrDefault(rec => rec.Id == model.Id);
            if (implementer == null)
            {
        ...
        private Implementers CreateModel(ImplementerBindingModel model, Implementers implementer)
        {
        ...
        private ImplementerViewModel CreateModel(Implementers implementer)
        {
